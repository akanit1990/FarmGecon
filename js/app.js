(() => {
    ...
    (() => {
        ...
        function scrolEndure() {
            let last_scroll = 0;
            let TulBar = document.querySelector(".tul-bar");
            if (TulBar) window.onscroll = function() {
                if (window.scrollY > last_scroll) {
                    TulBar.classList.add("down");
                    TulBar.classList.remove("up");
                } else {
                    TulBar.classList.add("up");
                    TulBar.classList.remove("down");
                }
        ...
        function initSliders() {
            if (document.querySelectorAll(".swiper-main-slider", ".swiper-first-section", ".catalog-slider", ".thumbs-min", ".thumbs-min")) {
                ...
                swiperElements.forEach((swiperElement => {
                    new core(swiperElement, {
                        ...
                        spaceBetween: 15,
                        navigation: {
                            prevEl: swiperElement.closest("section").querySelector(".main-slider-prev"),
                            nextEl: swiperElement.closest("section").querySelector(".main-slider-next")
                        },
                        breakpoints: {
                            320: {
                                spaceBetween: 10
                ...
                new core(".swiper-first-section", {
                    ...
                    navigation: {
                        prevEl: ".first-section-slider-prev",
                        nextEl: ".first-section-slider-next"
                    },
                    breakpoints: {
                        320: {
                            spaceBetween: 10
        ...
        let SortingButtons = document.querySelectorAll(".sorting-catalog__nav-buttons .sorting-catalog__btn");
        if (SortingButtons) SortingButtons.forEach((SortingButton => {
        ...
        if (nav) {
            nav.addEventListener("click", (function(e) {
                ...
                closeAllSumMenu(e.target.nextElementSibling);
                if (e.target.nodeName !== "BUTTON") return;
                if (e.target.classList.contains("active")) e.target.classList.remove("active"); else e.target.classList.add("active");
                e.target.nextElementSibling.classList.add("active");
            }));
            function closeAllSumMenu(current = null) {
                let SubMenu = document.querySelectorAll(".root-nav ul");
                let ButtonMenuAll = document.querySelectorAll(".root-nav li button");
                ButtonMenuAll.forEach((ButtonMenu => {
                    ButtonMenu.addEventListener("click", (function(e) {
                        ButtonMenuAll.forEach((element => {
                            element.classList.remove("active");
                        }));
                    }));
                }));
                if (!document.querySelectorAll(".root-nav ul li ul")) SubMenu.forEach((SubMenuItem => {
                    SubMenuItem.classList.remove("active");
                    console.log(SubMenuItem);
                }));
                let ColseSuMenu = document.querySelectorAll(".сlose-sub-menu");
                ColseSuMenu.forEach((CloseMenu => {
                    CloseMenu.addEventListener("click", (function(e) {
                        console.log(SubMenu);
                        let catalogMenu = document.querySelector("html");
                        if (window.screen.availWidth > 819.98) if (catalogMenu.closest(".menu-open")) {
                            catalogMenu.classList.remove("menu-open");
                            catalogMenu.classList.remove("lock");
                        }
            ...
            function TrigerButtons() {
                let Type = document.querySelector(".type-btn");
                let Direction = document.querySelector(".direction-btn");
                let allLinkdirection = document.querySelectorAll(".direction");
                let allLinkType = document.querySelectorAll(".type");
                Type.addEventListener("click", (function(e) {
                    if (Type.closest(".active")) {
                        console.log("да");
                        Type.classList.remove("active");
                        allLinkType.forEach((type => {
            ...
            TrigerButtons();
            let wrapmenu = document.querySelector(".catalog-menu");
            wrapmenu.onmouseleave = closeAllSumMenu;
            wrapmenu.onmouseleave = closeAllSumMenu;
        }
        document.querySelector(".calendar__box-grid");
        let CaledaryItem = document.querySelectorAll(".calendar-item");
        CaledaryItem.forEach((item => {
            item.addEventListener("click", (function(e) {
                CaledaryItem.forEach((element => {
                    element.classList.remove("_active");
                }));
                item.classList.add("_active");
            }));
        }));
        let search = document.querySelectorAll(".search_header");
        if (search) search.forEach((element => {
            console.log(element);
            let Intput = element.querySelector("input");
            console.dir(Intput.closest(".search_header"));
            Intput.addEventListener("input", (function(e) {
                if (Intput.value != "") {
                    let totalWidth = window.screen.width;
                    console.log(totalWidth);
                    if (window.screen.availWidth < 769) document.querySelector("html").classList.add("menu-open");
                    if (Intput.closest(".search_header")) {
                        console.log("Да");
                        document.querySelector("body").classList.add("blure");
                    }
                    element.classList.add("_active");
                } else {
                    if (window.screen.availWidth < 769) document.querySelector("html").classList.remove("menu-open");
                    element.classList.remove("_active");
                    document.querySelector("body").classList.remove("blure");
                }
            }));
            let btn = document.querySelector(".header-top__button-catalog");
        ...
        let TulbarTop = document.querySelectorAll(".top-tulbar");
        if (TulbarTop) TulbarTop.forEach((element => {
            let Button = element.querySelector(".top-tulbar__button-close");
